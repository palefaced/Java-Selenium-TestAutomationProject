...
public class JS_Scripts {
    public static void removeAllFrames(WebDriver driver) {
        ...
        for (int i = 0; i < 3; i++) { // Retry logic
            ...
            try {
                ...
                LoggerUtils.log.error(Constants_JS.INTERRUPTED_EXCEPTION, e);
    ...
    public static void scrollToBottom(WebDriver driver) {
        try {
            ...
            LoggerUtils.log.error(Constants_JS.FAILED_TO_SCROLL_TO_THE_BOTTOM_OF_THE_PAGE + e.getMessage());
            throw new RuntimeException(e);
        }
    }
    ...
    public static void scrollElementInToView(WebDriver driver, WebElement element) {
        try {
            ...
            LoggerUtils.log.error(Constants_JS.FAILED_TO_SCROLL_ELEMENT_INTO_VIEW + e.getMessage());
            throw new RuntimeException(e);
        }
    }
}
